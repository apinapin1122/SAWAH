...
legend.onAdd = function (map) {
	...
	div.innerHTML += 		'<dd class="_lbs_clip_lgd"><svg class="legendIcon"><rect width="18" height="18" stroke="rgba(35, 35, 35, 0.00)" stroke-width="3" fill="rgba(226, 242, 83, 1.00)"></svg>Irigasi Non-Teknis</dd>';
	div.innerHTML += 		'<dd class="_lbs_clip_lgd"><svg class="legendIcon"><rect width="18" height="18" stroke="rgba(35, 35, 35, 0.00)" stroke-width="3" fill="rgba(226, 244, 59, 1.00)"></svg>Irigasi Teknis</dd>';
	div.innerHTML += 		'<dd class="_lbs_clip_lgd"><svg class="legendIcon"><rect width="18" height="18" stroke="rgba(35, 35, 35, 0.00)" stroke-width="3" fill="rgba(63, 232, 44, 1.00)"></svg>Pasang Surut</dd>';
	div.innerHTML += 		'<dd class="_lbs_clip_lgd"><svg class="legendIcon"><rect width="18" height="18" stroke="rgba(35, 35, 35, 0.00)" stroke-width="3" fill="rgba(20, 128, 39, 1.00)"></svg>Rawa/Lebak</dd>';
	div.innerHTML += 		'<dd class="_lbs_clip_lgd"><svg class="legendIcon"><rect width="18" height="18" stroke="rgba(35, 35, 35, 0.00)" stroke-width="3" fill="rgba(14, 214, 18, 1.00)"></svg>Tadah Hujan</dd>';
